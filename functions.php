...
if ( ! function_exists( 'verano_scripts' ) ) {
	function theme_enqueue_styles() {
		...
		// Registrar script
		wp_register_script( 'verano-jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.8.0/jquery.min.js',
			array( 'jquery' ), false, true );
		wp_register_script( 'flexslider-js', 'http://flexslider.woothemes.com/js/jquery.flexslider.js',
			array( 'jquery' ), false, true );
		wp_register_script( 'verano-custom-js', get_stylesheet_directory_uri() . '/js/scripts.js', array( 'jquery' ),
			false, true );
